...
public class CallsLogs extends Activity
	...
	public void execute()
		...
		switch (GlobalVars.activityItemLocation)
			...
			case 2: //CALL TO NUMBER
				GlobalVars.talk(getResources().getString(R.string.layoutCallsMakeCallError));
			/*if (GlobalVars.callLogsReady==false)
				{
				GlobalVars.talk(getResources().getString(R.string.layoutCallsLogsPleaseTryAgain));
				}
			...
			case 3: //SEND A MESSAGE
				GlobalVars.talk(getResources().getString(R.string.layoutMessageLogsError));
			/*if (GlobalVars.callLogsReady==false)
				{
				GlobalVars.talk(getResources().getString(R.string.layoutCallsLogsPleaseTryAgain));
				}
			...
			case 4: //ADD TO NEW CONTACT
				GlobalVars.talk(getResources().getString(R.string.layoutaddcontact));
			/*if (GlobalVars.callLogsReady==false)
				{
				GlobalVars.talk(getResources().getString(R.string.layoutCallsLogsPleaseTryAgain));
				}
